...
@registry.reg("rocm.bilinear_upsampling2d_add.gen_function")
def gen_function(
    func_attrs,
    template_path,
    exec_cond_remplate,
...
@registry.reg("rocm.bilinear_upsampling2d_add.func_decl")
...
@registry.reg("rocm.bilinear_upsampling2d_add.func_call")
