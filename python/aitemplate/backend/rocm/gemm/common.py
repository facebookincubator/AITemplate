...
{% if gemm_flag not in ["bias_permute_m2n3", "bias_permute_m3n2"]  %}
{{indent}}                                M,
{{indent}}                                N,
{{indent}}                                K,
{{indent}}                                stride_a,
...
{% if gemm_flag == "" %}
{{indent}}                                ck::tensor_operation::element_wise::PassThrough{}
{% elif gemm_flag == "bias" or "permute" in gemm_flag %}
...
def gen_function_decl(func_name, gemm_flag, ndims=2, has_d0="", has_d1=""):
