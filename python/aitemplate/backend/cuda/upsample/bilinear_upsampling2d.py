...
@registry.reg("cuda.bilinear_upsampling2d.gen_function")
def gen_function(
    func_attrs,
    template_path,
    exec_cond_remplate,
...
@registry.reg("cuda.bilinear_upsampling2d.func_decl")
...
@registry.reg("cuda.bilinear_upsampling2d.func_call")
