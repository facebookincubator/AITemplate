...
@registry.reg("cuda.bilinear_upsampling2d_add.gen_function")
def gen_function(
    func_attrs,
    template_path,
    exec_cond_remplate,
    ...
    for key in exec_path:
        program = bilinear_upsampling2d_common.EXEC_TEMPLATE.render(bias_add=True)
...
@registry.reg("cuda.bilinear_upsampling2d_add.func_decl")
...
@registry.reg("cuda.bilinear_upsampling2d_add.func_call")
