...
def gemm_softmax_instance(op_def):
    """_summary_
...
def emit_instance(op, f_instance_convertor=gemm_softmax_instance, emit_kernel=False):
    import cutlass_lib
...
def gen_function(
    ...
    weight_ndims,
    dim_info_dict,
    f_instance_convertor=gemm_softmax_instance,
    emit_kernel=False,
