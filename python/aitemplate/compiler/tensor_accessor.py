...
class TensorAccessor(object):
    """
    A tensor accessor which handles strides.
    ...
    def __init__(self, original_tensor: Tensor) -> None:
        ...
        # original_dim_group is a list of indexes for self.original_shapes, and
        # actual_dim_group is a list of indexes for self.actual_shapes.
        #
    ...
    def try_get_stride_strs(
        ...
        """
        Tries to return a list of stride strs for the givem dim.
        ...
        def _get_value_or_names(shape: List[IntVar], indexes: List[int]) -> List[str]:
            res = []
    ...
    def stride(self, dim: int) -> int:
        """
        Returns stride (a number) for the givem dim.
