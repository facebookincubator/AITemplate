...
from aitemplate.compiler.base import ConstantTensor
...
def _pad_input_tensor(
    ...
    for dim_idx, dim in enumerate(original_shape):
        ...
        padding_tensor = ConstantTensor.create_host_zero_tensor(
...
def apply_padding(sorted_graph: List[Tensor]) -> List[Tensor]:
    """
