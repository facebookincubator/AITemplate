...
class TransformUtilsReplaceTensorTestCase(unittest.TestCase):
    def test_original_inputs_replace(self):
        ...
        module = gen_execution_module(X5, target, "./tmp", "original_inputs_replace")
        ...
        module.RunWithTensors([x_pt, x1_pt], [y])
    ...
    def test_is_view_of_replace(self):
        ...
        target = detect_target()
        module = gen_execution_module(X4, target, "./tmp", "view_replace")
