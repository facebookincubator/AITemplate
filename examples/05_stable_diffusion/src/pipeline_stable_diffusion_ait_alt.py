    ...
    for key, arr in state_dict.items():
        ...
        if key.startswith("transformer."):
            ...
            if new_key.endswith(".in_proj_weight"):
                ...
                new_state_dict[new_key + ".k_proj.weight"] = arr[d_model : d_model * 2, :]
...
class StableDiffusionAITPipeline:
    def __init__(self, hf_hub_or_path, ckpt):
        ...
        if ckpt is None:
            ...
            clip_state_dict["text_model.embeddings.position_ids"] = self.clip_pt.text_model.embeddings.get_buffer("position_ids")
